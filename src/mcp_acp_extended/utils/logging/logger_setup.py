...
from mcp_acp_extended.security.integrity.audit_handler import FailClosedAuditHandler
...
def setup_jsonl_logger(
    ...
    Args:
        logger_name: Name for the logger (e.g., "mcp-acp-extended.audit.client")
...
def setup_failclosed_audit_logger(
    ...
    Args:
        logger_name: Name for the logger (e.g., "mcp-acp-extended.audit.operations")
        log_file: Path to the log file
