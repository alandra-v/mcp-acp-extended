...
Logs are written to <log_dir>/mcp_acp_extended_logs/audit/operations.jsonl.
"""
...
from mcp_acp_extended.utils.logging.extractors import extract_client_info, extract_tool_metadata
...
def create_audit_logging_middleware(
    ...
    logger = setup_failclosed_audit_logger(
        "mcp-acp-extended.audit.operations",
        log_path,
