...
from mcp_acp_extended.telemetry.debug.backend_logger import (
    log_backend_error,
    log_backend_response,
    log_proxy_request,
    setup_backend_wire_logger,
)
from mcp_acp_extended.telemetry.models.wire import BackendResponseEvent
from mcp_acp_extended.telemetry.system.system_logger import get_system_logger
from mcp_acp_extended.utils.logging.extractors import extract_initialize_metadata
...
def create_logging_proxy_client(
    ...
    if debug_enabled:
        ...
        logger = logging.getLogger("mcp-acp-extended.debug.backend.null")
