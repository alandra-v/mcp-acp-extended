...
├─────────────────────────────────────────────────────────────────────────────┤
│ 1. User runs: mcp-acp-extended init  (configures OIDC)                      │
...
mcp-acp-extended auth status --json      # Output as JSON
mcp-acp-extended auth logout             # Clear stored credentials
mcp-acp-extended auth logout --federated # Also log out of IdP in browser
```
...
3. User runs: `mcp-acp-extended auth login`
