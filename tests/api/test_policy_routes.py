...
class TestGetPolicy:
    ...
    def test_returns_policy_with_metadata(self, client, sample_policy, mock_reloader):
        ...
        # Arrange
        with patch("mcp_acp_extended.api.routes.policy.load_policy", return_value=sample_policy):
            with patch(
                "mcp_acp_extended.api.routes.policy.get_policy_path",
    ...
    def test_returns_404_when_policy_missing(self, client, mock_reloader):
        ...
        # Arrange
        with patch(
            "mcp_acp_extended.api.routes.policy.load_policy",
