...
class TestVersion:
    ...
    def test_version_flag_shows_version(self, runner: CliRunner):
        ...
        assert "mcp-acp-extended" in result.output
...
class TestConfigEdit:
    ...
    def test_edit_missing_config_shows_error(self, runner: CliRunner):
        ...
        with runner.isolated_filesystem():
            with patch(
                "mcp_acp_extended.cli.commands.config.get_config_path",
    ...
    def test_edit_preserves_user_formatting(self, runner: CliRunner, valid_config: dict):
        ...
        with runner.isolated_filesystem() as tmpdir:
            ...
            with patch(
                ...
                with patch(
                    "mcp_acp_extended.cli.commands.config.get_config_history_path",
...
class TestInitCommand:
    ...
    def test_init_non_interactive_missing_log_dir_shows_error(self, runner: CliRunner):
        ...
        with runner.isolated_filesystem() as tmpdir:
            ...
            with patch(
                "mcp_acp_extended.cli.commands.init.get_config_path",
                return_value=config_path,
            ):
                with patch(
                    "mcp_acp_extended.cli.commands.init.get_policy_path",
        ...
        with runner.isolated_filesystem() as tmpdir:
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        "mcp_acp_extended.cli.commands.init.check_http_health",
